namespace ArgonautReverse
{
	...
	public class UnsupportedSerialization:NotImplementedException
	{
	...
	public abstract class ReverseError:Exception
	{
		...
		public ReverseError(string explanation, int? absolute_file_offset = null)
		{
			this.explanation = explanation;
			this.absolute_file_offset = absolute_file_offset;
		}
	...
	public class NegativeIndexError:ReverseError
	{
		...
		public NegativeIndexError(int absolute_file_offset, string cause, int value, object entire):base($"A negative {cause} index has been found: {value}. Whole {cause}: {entire}", absolute_file_offset){}
	}

	public class VerticesNormalsGroupsMismatch:ReverseError
	{
		public VerticesNormalsGroupsMismatch(int n_vertices_groups, int n_normals_groups, int absolute_file_offset):base($"Different amounts of vertices groups ({n_vertices_groups}) and normals groups ({n_normals_groups}) found.", absolute_file_offset){}
	}

	public class IncompatibleAnimationError:ReverseError
	{
		public IncompatibleAnimationError(int n_model_vg, int n_anim_vg):base($"This model has {n_model_vg} vertex groups, but this animation is designed for models with {n_anim_vg} vertex groups, thus they are incompatible."){}
	}

	public class ZeroRunLengthError:ReverseError
	{
