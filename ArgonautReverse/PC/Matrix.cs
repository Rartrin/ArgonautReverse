...
{
	public unsafe struct Matrix4x4F:IReadable<Matrix4x4F>,IEquatable<Matrix4x4F>
	{
		...
		public unsafe bool Equals(Matrix4x4F that)
		{
			fixed(Matrix4x4F* this0 = &this)
			{
		...
		//public ref float this[int column, int row] => ref m[column][row];
	}
}
